...
//#include "../gltextoverlay/gltextoverlay/gstgltextoverlay.h"
  ...
  while(!end_flag){
    ...
    if(selector==1){
       ...
       if(test_selector==1){
         ...
         mult+=0.1;
         g_object_set(gltextoverlay,"text-size-mult",mult,NULL);
         g_object_set(gltextoverlay,"text","text2 Текст Длинный",NULL);

         usleep(1000000);
         mult+=0.1;
         g_object_set(gltextoverlay,"text-size-mult",mult,NULL);
         g_object_set(gltextoverlay,"text","text3 Текст Длинный",NULL);
